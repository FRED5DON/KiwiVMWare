...
public class AppEnv {
    ...
    public static final String PATH_CACHE = PATH_DATA + File.separator + "eCache";
    ...
    public static void toggleWiFi(Context context, boolean enabled) {
        ...
        if (pm.checkPermission("android.permission.CHANGE_WIFI_STATE", context.getPackageName()) == PackageManager.PERMISSION_GRANTED) {
    ...
    public static String getIMEI(Context context) {
        if (PermissionUtil.getInstance().checkPermission(context,android.Manifest.permission.READ_PHONE_STATE)){
