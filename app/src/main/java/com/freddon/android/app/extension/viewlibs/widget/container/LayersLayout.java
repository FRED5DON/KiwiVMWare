package com.freddon.android.app.extension.viewlibs.widget.container;
...
import com.freddon.android.app.extension.viewlibs.widget.MaskLayoutView;
import com.freddon.android.app.extension.viewlibs.widget.MaskLoadingView;
...
public class LayersLayout extends FrameLayout {
    ...
    @BindView(R.id.empty_layout_mask)
    MaskLayoutView emptyLayoutMask;
    @BindView(R.id.empty_layout_neterror)
    MaskLayoutView emptyLayoutNetError;
    @BindView(R.id.empty_layout_exception)
    ...
    @OnClick({R.id.empty_layout_mask, R.id.empty_layout_neterror, R.id.empty_layout_exception})
    public void onMaskLayerClickEvent(View v) {
        int layerType;
        switch (v.getId()) {
            case R.id.empty_layout_mask:
                layerType = LAYER_DATA_EMPTY;
                break;
            case R.id.empty_layout_neterror:
                layerType = LAYER_NET_ERROR;
                break;
            case R.id.empty_layout_exception:
